...
class ComunicadosController extends Controller
{
    ...
    public function view()
    {
        ...
        return view('admin.comunicados', 
            [
                'fontsAdmin' => $fontsAdmin, 
                'stylesAdmin' => array_merge($cssAdmin, array(array('href' => 'adminAssets/global/vendor/summernote/summernote.css'), array('href' => 'adminAssets/global/vendor/alertify/alertify.css'), array('href' => 'adminAssets/global/vendor/notie/notie.css'), array('href' => 'adminAssets/assets/examples/css/advanced/alertify.css'), array('href' => 'adminAssets/global/vendor/webui-popover/webui-popover.css'), array('href' => 'adminAssets/global/vendor/toolbar/toolbar.css'))), 
                'headJsAdmin' => $headJsAdmin, 
                'bodyJsAdmin' => array_merge($bodyJsAdmin, array(array('src' => 'adminAssets/global/vendor/summernote/summernote.min.js'), array('src' => 'adminAssets/global/js/Plugin/summernote.js'), array('src' => 'adminAssets/assets/examples/js/forms/editor-summernote.js'), array('src' => 'adminAssets/global/js/Plugin/jquery-placeholder.js'), array('src' => 'adminAssets/global/js/Plugin/material.js'), array('src' => 'adminAssets/global/vendor/asprogress/jquery-asProgress.js'), array('src' => 'adminAssets/global/vendor/draggabilly/draggabilly.pkgd.js'), array('src' => 'adminAssets/global/vendor/raty/jquery.raty.js'), array('src' => 'adminAssets/global/js/Plugin/responsive-tabs.js'), array('src' => 'adminAssets/global/js/Plugin/tabs.js'), array('src' => 'adminAssets/global/js/Plugin/asprogress.js'), array('src' => 'adminAssets/global/js/Plugin/panel.js'), array('src' => 'adminAssets/global/js/Plugin/asscrollable.js'), array('src' => 'adminAssets/global/js/Plugin/raty.js'), array('src' => 'adminAssets/assets/examples/js/uikit/panel-structure.js'), array('src' => 'adminAssets/global/vendor/alertify/alertify.js'), array('src' => 'adminAssets/global/vendor/notie/notie.js'), array('src' => 'adminAssets/global/js/Plugin/alertify.js'), array('src' => 'adminAssets/global/js/Plugin/notie-js.js')
                , array('src' => 'adminAssets/global/vendor/webui-popover/jquery.webui-popover.min.js')
                , array('src' => 'adminAssets/global/vendor/toolbar/jquery.toolbar.js')
                , array('src' => 'adminAssets/global/js/Plugin/webui-popover.js')
                , array('src' => 'adminAssets/global/js/Plugin/toolbar.js')
                , array('src' => 'adminAssets/assets/examples/js/uikit/tooltip-popover.js'))), 
                'esLogin' => false, 
                'bodyClass' => 'dashboard', 'bodyStyle' => 'animation-duration: 800ms; opacity: 1;', 
                'comunicados' => $this->traerR() ]);
    }
