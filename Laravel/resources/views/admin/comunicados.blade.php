            ...
            <div class="mega-content">
                ...
                <div class="col-md-4">
                    ...
                    <li>
                        ...
                        <img class="w-full" src="{{ url('adminAssets/global/photos/placeholder.png') }}" alt="..." />
                        </a>
                    </li>
                    <li>
                        <a class="thumbnail m-0" href="javascript:void(0)">
                ...
                <div data-role="content">
                    ...
                    <div class="media">
                        ...
                        <span class="avatar avatar-sm avatar-online">
                            <img src="{{ url('adminAssets/global/portraits/2.jpg') }}" alt="..." />
                            <i></i>
                        </span>
                        </div>
                        <div class="media-body">
                    ...
                    <div class="media">
                        ...
                        <span class="avatar avatar-sm avatar-off">
                            <img src="{{ url('adminAssets/global/portraits/3.jpg') }}" alt="..." />
                            <i></i>
                        </span>
                        </div>
                        <div class="media-body">
                    ...
                    <div class="media">
                        ...
                        <span class="avatar avatar-sm avatar-busy">
                            <img src="{{ url('adminAssets/global/portraits/4.jpg') }}" alt="..." />
                            <i></i>
                        </span>
                        </div>
                        <div class="media-body">
        ...
        <ul class="site-menu" data-plugin="menu">
            ...
            <li class="site-menu-item has-sub">
                ...
                <ul class="site-menu-sub">
                    ...
                    <li class="site-menu-item">
                        <a class="animsition-link" href="{{ url('/admin/menu') }}">
