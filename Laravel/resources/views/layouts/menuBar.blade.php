            ...
            <div class="container">
                <div class="row">
                    <div class="header-table col-md-12 header-menu">
                        ...
                        <div class="brand">
                            <a href="{{ (url()->current() == url('Inicio'))? '#': '/Inicio' }}" class="nav-link"><img src="{{ url('img/logo_0001.png') }}" alt="Logo AOPIP" height="65"/></a>
                        </div>
                        <!--  // Logo section -->
                        ...
                        <nav class="main-nav">
                            ...
                            <ul  id="home_nav" class="nav">
                                ...
                                <li><a href="#" class="nav-link {{ (url()->current() == url('Contacto'))? 'selected': '' }}" style="font-size: 17px;">Contáctanos</span></a>
                                    <ul>
                                        <li><a href="{{ (url()->current() == url('Contacto/Numeros_Anexos'))? '#': '/Contacto/Numeros_Anexos' }}" class="nav-link {{ (url()->current() == url('Contacto/Numeros_Anexos'))? 'selected': '' }}" style="font-size: 17px;">Números y Anexos</span></a></li>
